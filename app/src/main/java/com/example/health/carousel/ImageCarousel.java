...
public class ImageCarousel {
    ...
    public ImageCarousel(Context context, ViewPager viewPager, TextView tvTitle, List<View> dots, int time) {
        this.context = context;
        this.viewPager = viewPager;
        this.tvTitle = tvTitle;
        this.dots = dots;
        this.time = time;
        Log.e("ImageCarousel123", "构造方法");
    }

    /**
     * 传入数据
     *
     * @param simpleDraweeViews SimpleDraweeView集合
     * @param titles            标题数组
     * @return this 本身
     */
    public ImageCarousel init(List<SimpleDraweeView> simpleDraweeViews, String[] titles) {
        this.simpleDraweeViews = simpleDraweeViews;
        this.titles = titles;
        Log.e("ImageCarousel123", "初始化");
     ...
     * @param titles            标题数组
     */
    private void reload(List<SimpleDraweeView> simpleDraweeViews, String[] titles) {
        init(simpleDraweeViews, titles);
        previousPosition = 0;
        start();
    ...
    public void start() {
        ...
        adapter = new ImagesPagerAdapter(this.simpleDraweeViews, viewPager, context);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                int newPosition = position % simpleDraweeViews.size();
    ...
    private void setFirstLocation() {
        ...
        dots.get(0).setBackgroundResource(R.drawable.ic_dot_focused);
        ...
        public synchronized void run() {
            while (!isExit) {
                try {
                    ...
                    Log.e("ImageCarousel123", "强制请求退出线程");
                    break;
                }
                ...
                if (this.interrupted()) {
                    Log.e("ImageCarousel123", "已经是停止状态了，我要退出了");
                    break;
                }
