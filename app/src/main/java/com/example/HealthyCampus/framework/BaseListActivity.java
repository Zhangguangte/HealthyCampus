 ...
 * @param <D>
 */
public abstract class BaseListActivity<V extends BaseView,T extends BasePresenter<V>,D> extends BaseFragment<V,T> implements PullRecycler.OnRecyclerRefreshListener {
