...
import com.example.HealthyCampus.module.Message.Chat.imageselect.ImageSelectView;
...
public class ImageSelectAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.d("ImageSelectAdapter123", "position = "+position);
        Log.d("ImageSelectAdapter123", "uri = "+mImages.get(position));
