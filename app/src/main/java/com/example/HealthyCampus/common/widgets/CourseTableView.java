...
public class CourseTableView extends RelativeLayout {
    ...
    private List<? extends CourseVo> coursesData;
    ...
    private void init(Context context) {
        ...
        twoW = DensityUtil.dip2Px(2, context);
        oneW = DensityUtil.dip2Px(1, context);
    ...
    public void updateCourseViews(List<? extends CourseVo> coursesData) {
    ...
    private void updateCourseViews() {
        ...
        TextView tv;
        for (final CourseVo c : coursesData) {
            final int jieci = c.getStart();
            final int day = c.getWeek();
            fl = new FrameLayout(getContext());
            flp = new FrameLayout.LayoutParams(notFirstEveryColumnsWidth,
                    notFirstEveryRowHeight * c.getPeriod());
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onCourseItemClickListener != null)
                        onCourseItemClickListener.onCourseItemClick((TextView) v, jieci, day, c.getDescribe());
                }
            });
            fl.addView(tv);
            myCacheViews.add(fl);
    ...
    private void initSize() {
        ...
        firstRowHeight = DensityUtil.dip2Px( 40,getContext());
        notFirstEveryColumnsWidth = screenWidth * 2 / (2 * totalDay + 1);
        notFirstEveryRowHeight = (screenHeight - firstRowHeight) / totalJC +  DensityUtil.dip2Px(5,getContext());
