 ...
 * OK
 */
public class ChatPullRecycler extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private PullRecycler.OnRecyclerRefreshListener listener;
    private PullRecycler.OnRecyclerScrollListener scrollListener;
    ...
    public ChatPullRecycler(Context context) {
        super(context);
        setUpView();
    }

    public ChatPullRecycler(Context context, AttributeSet attrs) {
        super(context, attrs);
        setUpView();
    }

    public ChatPullRecycler(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnRefreshListener(PullRecycler.OnRecyclerRefreshListener listener) {
        this.listener = listener;
    }

    public void setOnScrollListener(PullRecycler.OnRecyclerScrollListener listener){
